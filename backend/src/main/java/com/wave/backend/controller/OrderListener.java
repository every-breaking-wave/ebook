...
public class OrderListener {
    ...
    public void topicListener(ConsumerRecord<String, String> record) throws DecodeException, EncodeException {
        ...
        ws.sendMessageToUser(createOrderResponse.getUserId().toString(), createOrderResponse.toString());
        KafkaMessage kafkaMessage = new KafkaMessage(createOrderResponse.getStatus().toString(), createOrderResponse.getId(), createOrderResponse.getUserId());
